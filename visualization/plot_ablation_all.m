...
variant_order = {'proposed', 'no_phi_t', 'no_pv_interpolation', 'no_migration', 'no_subpop'};
variant_labels_map = struct( ...
    'proposed', 'Proposed cSA-GOA', ...
    'no_phi_t', 'w/o φ_t Scheduling', ...
    'no_pv_interpolation', 'w/o PV Exchange', ...
    'no_migration', 'w/o Elite Migration', ...
    'no_subpop', 'w/o Multi-Subpop');
variant_colors_map = struct( ...
    'proposed', [0.8500, 0.3250, 0.0980], ...
    'no_phi_t', [0.0000, 0.4470, 0.7410], ...
    'no_pv_interpolation', [0.9290, 0.6940, 0.1250], ...
